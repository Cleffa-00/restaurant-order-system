// app/api/v1/admin/menu-items/[id]/route.ts
...
// GET /api/v1/admin/menu-items/[id] - 获取单个菜单项
...
// PUT /api/v1/admin/menu-items/[id] - 更新菜单项（包括选项组）
...
// DELETE /api/v1/admin/menu-items/[id] - 删除菜单项（软删除）
