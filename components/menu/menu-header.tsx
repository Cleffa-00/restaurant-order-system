...
// 定义 ref 的类型
export interface MenuHeaderRef {
  triggerAnimation: (isDecrease?: boolean) => void
}

export const MenuHeader = forwardRef<MenuHeaderRef, MenuHeaderProps>(
  ({ onMenuClick, onCartClick = () => {}, showMenuButton = true }, ref) => {
