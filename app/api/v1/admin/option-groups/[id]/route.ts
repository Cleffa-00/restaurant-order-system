// app/api/v1/admin/option-groups/[id]/route.ts
...
// GET /api/v1/admin/option-groups/[id] - 获取单个选项组
...
// PUT /api/v1/admin/option-groups/[id] - 更新选项组
...
// DELETE /api/v1/admin/option-groups/[id] - 删除选项组（软删除）
